         ...
         <div className="container container-large">
            <div className="position-relative">
                        ...
                        <div className="listing-card-one style-two shadow-none h-100 w-100">
                           ...
                           <div className="property-info pt-20">
                              ...
                              <div className="pl-footer top-border bottom-border d-flex align-items-center justify-content-between">
                                 ...
                                 <Link href="/listing" className="btn-four"><i className="bi bi-arrow-up-right"></i></Link>
                              </div>
                           </div>
                        </div>
                     </div>
               ...
               <div className="section-btn text-center md-mt-60">
                  <Link href="/listing" className="btn-eight"><span>Explore All</span> <i className="bi bi-arrow-up-right"></i></Link>
               </div>
            </div>
         </div>
      </div>
