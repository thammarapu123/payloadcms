                  ...
                  <div className="ps-xxl-5">
                     <div className="listing-header-filter d-sm-flex justify-content-between align-items-center mb-40 lg-mb-30">
                        ...
                        <div className="d-flex align-items-center xs-mt-20">
                           ...
                           <Link href="/listing" className="tran3s layout-change rounded-circle ms-auto ms-sm-3"
                           ...
                           <div key={item.id} className="col-md-6 d-flex mb-50 wow fadeInUp" data-wow-delay={item.data_delay_time}>
                              <div className="listing-card-one border-25 h-100 w-100">
                                          ...
                                          <div className="carousel-inner">
                                             {item.carousel_thumb.map((item: any, i: any) => (
                                                <div key={i} className={`carousel-item ${item.active}`} data-bs-interval="1000000">
                                                   <Link href="/listing_details" className="d-block"><Image src={item.img} className="w-100" alt="..." /></Link>
                                                </div>
                                             ))}
                                          </div>
                                       </div>
                                 ...
                                 <div className="property-info p-25">
                                    <Link href="/listing_details" className="title tran3s">{item.title}</Link>
                                    ...
                                    <div className="pl-footer top-border d-flex align-items-center justify-content-between">
                                       ...
                                       <Link href="/listing_details" className="btn-four rounded-circle"><i className="bi bi-arrow-up-right"></i></Link>
                                    </div>
                                 </div>
                              </div>
                           </div>
