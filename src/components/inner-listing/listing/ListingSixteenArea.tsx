                        ...
                        <div key={item.id} className="col-md-6 d-flex mb-40 wow fadeInUp">
                           <div className="listing-card-one style-two shadow-none h-100 w-100">
                              ...
                              <div className="property-info pt-20">
                                 <Link href="/listing" className="title tran3s">{item.title}</Link>
                                 ...
                                 <div
                                    ...
                                    <strong className="price fw-500 color-dark">R {item.price.toLocaleString({ minimumFractionDigits: 2, maximumFractionDigits: 2 })} {item.price_text && <>/ <sub>m</sub></>}</strong>
                                    <Link href="/listing" className="btn-four">
