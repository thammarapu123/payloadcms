                        ...
                        <div className="caption">
                           <div className="d-flex justify-content-between align-items-center">
                              <div className="title">
                                 ...
                                 <Link href="/project_details"><h4 className="tran3s">{item.title}</h4></Link>
                              </div>
                              <Link href="/project_details" className="btn-thirteen rounded-circle"><i className="bi bi-arrow-up-right"></i></Link>
                           </div>
                        </div>
                     </div>
                  </div>
