               ...
               <div className="row">
                  <div className="col-xl-8 m-auto">
                     <div className="modal-content">
                        <button type="button" className="btn-close ms-auto mt-20 me-4" data-bs-dismiss="modal" aria-label="Close" ref={closeButtonRef}><i className="fa-regular fa-xmark"></i></button>
                                 ...
                                 <div className="row gx-lg-5">
                                    <div className="col-md-6">
                                       <div className="input-box-one mb-35">
                                          ...
                                          <NiceSelect className="nice1-select fw-normal"
                                             options={[
                                    ...
                                    <div className="col-md-6">
                                       <div className="input-box-one mb-35">
                                          ...
                                          <NiceSelect className="nice1-select location fw-normal"
                                             options={[
                                    ...
                                    <div className="col-md-6">
                                       ...
                                       <div className="col-12">
                                          <button className="fw-500 text-uppercase tran3s apply-search w-100 mt-40 mb-25" onClick={handleSearch}>
